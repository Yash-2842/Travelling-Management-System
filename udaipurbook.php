    ...
    <div class="col-md-6 mt-3 mb-2">
        ...
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner"  >
                <div class="carousel-item active">
                    <img src="udai.jpg" class="d-block w-100" alt="" height="300px" >
                </div>
                <div class="carousel-item">
                    <img src="u1.jpg" class="d-block w-100" alt="" height="300px">
                </div>
            </div>
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <p class="card-text">Udaipur, formerly the capital of the Mewar Kingdom, is a city in the western Indian state of Rajasthan. Founded by Maharana Udai Singh II in 1559, it’s set around a series of artificial lakes and is known for its lavish royal residences. City Palace, overlooking Lake Pichola.</p>
            </div>
            <ul class="list-group list-group-flush">
                <li class="list-group-item">Udaipur, Rajasthan, India</li>
