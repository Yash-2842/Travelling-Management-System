    ...
    <div class="col-md-6 mt-3 mb-2">
        ...
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner"  >
                <div class="carousel-item active">
                    <img src="taj.jpg" class="d-block w-100" alt="" height="300px" >
                </div>
                <div class="carousel-item">
                    <img src="tj3.jpg" class="d-block w-100" alt="" height="300px">
                </div>
            </div>
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <p class="card-text">Agra is a city on the banks of the river Yamuna in the northern state of Uttar Pradesh, India.</p>
            </div>
            <ul class="list-group list-group-flush">
                <li class="list-group-item">Agra, Uttar Pradesh, India</li>
